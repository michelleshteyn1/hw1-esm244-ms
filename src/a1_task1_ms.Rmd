...
Below, I will create a column graph containing containing total counts (over all years of the study) of combined adult and subadult endangered mountain yellow-legged frogs observed in the 5 lakes with the greatest total observed counts. 
...
plot_b <- ggplot(data = top_5_frog, aes(x = fct_reorder(lake_id_txt,frog_count), y = frog_count)) +
  ...
  labs(y = "Frog Count", x = "Lake ID", title = "Top 5 Adult Frog Counts from 8 Lakes") +
  coord_flip() +
  theme_minimal() +
